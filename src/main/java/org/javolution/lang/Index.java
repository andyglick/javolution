...
public final class Index extends Number implements Comparable<Index>, Immutable {
  ...
  public int compareTo(long unsignedValue) {
    ...
    if (MathLib.unsignedLessThan(this.unsigned, unsignedValue)) {
      return -1;
    }
    else if (this.unsigned == unsignedValue) {
      return 0;
    }
    else {
      return 1;
  ...
  public int compareTo(int unsignedValue) {
    ...
    if (MathLib.unsignedLessThan(this.unsigned, MathLib.unsigned(unsignedValue))) {
      return -1;
    }
    else if (this.unsigned == unsignedValue) {
      return 0;
